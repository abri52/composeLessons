...
fun task5() {
    Column(
        modifier = Modifier.padding(top = 21.dp, start = 17.dp, end = 17.dp, bottom = 22.dp)
    ) {
        Box(
            contentAlignment = Alignment.Center,
            modifier = Modifier.fillMaxWidth()
        ) {
            val image: Painter = painterResource("task5/Prato.png") // Укажите путь к вашему изображению
            Image(
                painter = image,
        ...
        Row(
            ...
            val likes: Painter = painterResource("task5/likes.png")
            Image(
                painter = likes,
                contentDescription = "relogio",
